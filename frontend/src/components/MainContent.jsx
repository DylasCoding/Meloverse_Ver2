    ...
    <>
        ...
        <div className="left">
          <div className="info">
            ...
            <div className="buttons">
              <button onClick={() => handleSongClick(top1Song.id, fetchSong)}>Listen Now</button>
      ...
      <div className="playlist">
        <div className="Made-for">
          ...
          <div className="items">
            <div className="item" onClick={() => handleMixClick("Your MegaMix")}>
              <p>Your MegaMix</p>
            ...
            <div className="item" onClick={() => handleMixClick("Top Global Mix")}>
              <p>Top Global Mix</p>
              <img src="assets/3.png" alt="" />
            </div>
            <div className="item" onClick={() => handleMixClick("Chilling with Meloverse")}>
              ...
              top10Songs.map((top10Songs, index) => (
                ...
                >
                  ...
                  <div className="actions">
                    ...
                    <i className="bx bxs-plus-square add-fav"></i>
                    <i className="bx bxs-heart add-fav"></i>
                  </div>
                </div>
              ))}
          </div>
      ...
      <div className="hobby-scroll">
        ...
        <div className="items">
              {history.map((historyItem) => (
                <div className="item" key={historyItem.id} onClick={() => handleSongClick(historyItem.song.id, fetchSong)}>
